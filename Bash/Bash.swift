...
public struct Bash {
     ...
     */
    @discardableResult
    public static func exec(command: String, arguments: [String], at path: String, output outputHandle: FileHandle?, error errorHandle: FileHandle?) throws -> String {
        let process = Process()
...
public extension Bash {
     ...
     */
    @discardableResult
    public static func exec(commands: [String], at path: String = ".", output outputHandle: FileHandle? = nil, error errorHandle: FileHandle? = nil) -> String {
        do {
...
public extension Bash {
     ...
     */
    @discardableResult
    public static func run(_ command: String, args arguments: [String] = [], at path: String = ".", output outputHandle: FileHandle? = nil, error errorHandle: FileHandle? = nil) throws -> String {
...
public extension Bash {
     ...
     */
    @discardableResult
    public static func run(commands: [String], at path: String = ".", ouput outputHandle: FileHandle? = nil, error errorHandle: FileHandle? = nil) throws -> String {
        let command = commands.joined(separator: " && ")
...
public extension Bash {
     ...
     */
    @discardableResult
    public static func run(_ commands: [Bash.Command], at path: String = ".", ouput outputHandle: FileHandle? = nil, error errorHandle: FileHandle? = nil) throws -> String {
...
public struct BashError: Swift.Error {
